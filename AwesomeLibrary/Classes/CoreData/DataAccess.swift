...
public class DataAccess: NSObject {
    ...
    static public var sharedInstance = DataAccess()
    ...
    public lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.itsdayoff.LanguageQuiz" in the application's documents Application Support directory.
